...
namespace CAM.Common.Convert
{
    ...
    public static class StringConvertor
    {
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static string ToPinYin(this string x)
        {
            int[] iA = new int[]
            {
        ...
        public static string ToPinYinFirstChar(this string CnStr)
        {
            string strTemp = "";
        ...
        public static string ToMD5HashCode(this string text)
        {
